...
\subsection{G25 – Kurvenverläufe}
Der Wrkungsgrad steigt erst und fällt nach seinen Maximum wieder ab. Die Lastleistung steigt ebenso bis zu einen gewissen grad, jedoch fällt sie danach wieder ab. Dies liegt daran, dass bei einer zu hohen Last der Strom immer weiter sinkt, da die Spannung an der Quelle konstant bleibt. Somit sinkt auch die Leistung, da diese ja aus dem Produkt von Spannung und Strom besteht.
\\Beide Verlaufe entsprechen der theorie und haben ihre Maxima bei \(R_x = R_0\), sprich Wirkungsgrad von \(50\%\) und maximale Leistung von \(P_{\max} = \dfrac{U_{\mathrm{ges}}^2}{4R_0}\).
